...
ChatLogic::ChatLogic()
{
   // The chatbot does not belong to this class any more, so needs no handling
}
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // store reference in child node and parent node      
                          	// Parents are referred to, but children are actually owned
    ...
    // Create a local instance of chatbot - does not belong to chatlogic
  	ChatBot local("../images/chatbot.png");
  
  // Connect the bot to chatlogic
  	local.SetChatLogicHandle(this);
      
    // Connect the bot to the initial node  
    local.SetRootNode(rootNode);
  
  	// Move the node to the right place
